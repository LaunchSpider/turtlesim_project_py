...
class TurtleControllerNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("P_controller_linear_coeff", 2)
        self.declare_parameter("P_controller_angular_coeff", 6)

        self.catch_closest_turtle_first_ = self.get_parameter(
            "catch_closest_turtle_first").value
        self.P_controller_linear_coeff = self.get_parameter(
            "P_controller_linear_coeff").value
        self.P_controller_angular_coeff = self.get_parameter(
            "P_controller_angular_coeff").value
    ...
    def control_loop(self):
        ...
        if distance > 0.5:
            msg.linear.x = self.P_controller_linear_coeff*distance
            ...
            msg.angular.z = self.P_controller_angular_coeff*diff
        else:
            msg.linear.x = 0.0
            msg.angular.z = 0.0
